...
var p2DebugDraw = (function () {
    function p2DebugDraw(world, sprite, height) {
        this.COLOR_D_SLEEP = 0xffffff; //0x999999;
        this.COLOR_D_WAKE = 0xffffff; //0xe5b2b2;
        this.COLOR_K = 0xffffff; //0x7f7fe5;
        this.COLOR_S = 0xffffff; //0x7fe57f;
        this.COLOR_BLACK = 0xffffff; //0x000000;
        this.COLOR_RED = 0xffffff;
    ...
    p2DebugDraw.prototype.drawDebug = function (except) {
        //alert(except);
    ...
    p2DebugDraw.prototype.drawLineConvex = function (vertices, color, alpha, fillColor) {
        if (alpha === void 0) { alpha = 1; }
